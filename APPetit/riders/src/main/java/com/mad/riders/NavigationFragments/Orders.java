        ...
        listenerQuery = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot d : dataSnapshot.getChildren()) {
                    ...
                    Log.e("TAG", "onDataChange: "+order.getAddrRestaurant() );
//                    pos_restaurant = getLocationFromAddress("J23X+C8R, Station Road, Saddar, Rawalpindi, Punjab 4600, Pakistan");
    ...
    private void setOrderView(View view,OrderRiderItem order)
    {
        ...
        Log.e("TAG", "setOrderView: "+order.getAddrRestaurant() );
        ...
        cash_text.setText(order.getTotPrice() + " PKR");
    }
